...
class CAS_Client
{
    ...
    private function _readExtraAttributesCas20($success_elements)
    {
        ...
        //
        if (
            $this->_casAttributeParserCallbackFunction !== null
